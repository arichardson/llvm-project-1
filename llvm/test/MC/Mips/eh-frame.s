...
// RUN: llvm-objdump -r -section=.rel.eh_frame %t.o | FileCheck --check-prefixes=RELOCS,REL32 %s
...
// RUN: llvm-objdump -r -section=.rela.eh_frame %t.o | FileCheck --check-prefixes=RELOCS,REL64 %s
...
// RUN: llvm-objdump -r -section=.rela.eh_frame %t.o | FileCheck --check-prefixes=RELOCS,PIC64 %s
...
// RELOCS:     RELOCATION RECORDS FOR [.eh_frame]:
// REL32-NEXT:    R_MIPS_32
// REL64-NEXT:    R_MIPS_64/R_MIPS_NONE/R_MIPS_NONE
