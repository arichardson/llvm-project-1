...
int _test__divtf3(int line, f128 a, f128 b,
...
int main() {
  ...
  // +Inf / positive = +Inf
  if (test__divtf3(makeInf128(), 3.Q,
  ...
  if (test__divtf3(makeInf128(), -3.Q,
    ...
    return 1;
  // -Inf / positive = -Inf
  if (test__divtf3(makeNegativeInf128(), 3.Q,
                   UINT64_C(0xffff000000000000),
                   UINT64_C(0x0)))
    return 1;
  // -Inf / negative = +Inf
  ...
  if (test__divtf3(makeInf128(), makeInf128(),
    ...
    return 1;
  // 0.0 / 0.0 = NaN
  if (test__divtf3(+0x0.0p+0Q, +0x0.0p+0Q,
                   UINT64_C(0x7fff800000000000),
                   UINT64_C(0x0)))
    return 1;
  // +0.0 / +Inf = +0.0
  if (test__divtf3(+0x0.0p+0Q, makeInf128(),
                   UINT64_C(0x0),
                   UINT64_C(0x0)))
    return 1;
  // +Inf / +0.0 = +Inf
  if (test__divtf3(makeInf128(), +0x0.0p+0Q,
                   UINT64_C(0x7fff000000000000),
                   UINT64_C(0x0)))
    return 1;

  // positive / +0.0 = +Inf
  if (test__divtf3(+1.0Q, +0x0.0p+0Q,
                   UINT64_C(0x7fff000000000000),
                   UINT64_C(0x0)))
    return 1;
  // positive / -0.0 = -Inf
  ...
  // 1/3
  if (test__divtf3(1.Q, 3.Q,
                   UINT64_C(0x3ffd555555555555),
                   UINT64_C(0x5555555555555555)))
    return 1;
  // smallest normal result
  if (test__divtf3(0x1.0p-16381Q, 2.Q,
  ...
  if (test__divtf3(0x1.0p-16382Q, 2.Q, UINT64_C(0x0000800000000000), UINT64_C(0x0)))
    return 1;
  // smallest subnormal result
  if (test__divtf3(0x1.0p-16382Q, 0x1p+112Q, UINT64_C(0x0), UINT64_C(0x1)))
    return 1;
